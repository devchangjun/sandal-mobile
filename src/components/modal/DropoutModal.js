                ...
                <div className={styles['container']}>
                    ...
                    <div className={styles['content']}>
                        <div className={styles['explan']}>
                            <p>
                            탈퇴 후 회원정보 및 이용기록은 모두 삭제되며 다시
                            복구가 불가 합니다.</p><br/> 
                            <p>주문내역 및 결제 내용은
                            이용약관과 관련법에 의하여 보관됩니다.</p><br/> 
                            <p>동일한
                            SNS계정과 이메일을 사용한 재가입은 24시간이내에
                            불가합니다.</p><br/>
                        </div>
                    </div>
                    ...
                    <div className={styles['content']}>
                        <div className={styles['agree']}>
                           ...
                           <CircleCheckBox  id={"agree"} text={"예, 탈퇴를 신청합니다."} check={agree} onChange={onChangeAgree}/>
