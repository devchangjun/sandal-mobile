        ...
        <svg width="24" height="24.002" viewBox="0 0 24 24.002">
            <g transform="translate(-286 -1357)">
                <rect
                    width="24"
                    height="24"
                    transform="translate(286 1357)"
                    fill="none"
                />
                <g transform="translate(-0.499 1)">
                    <g
                        transform="translate(292.5 1356)"
                        fill="none"
                    ...
                    <g transform="translate(-13347.5 -149)" fill="none">
                        <path
                            d="M13635.957,1529h-.914c-.03-.371-.044-.7-.044-1a11,11,0,1,1,22,0c0,.353-.015.688-.045,1l-.91,0c.009-5.968-4.415-10.9-9.862-11l-.173,0c-5.441,0-9.95,4.852-10.052,10.815,0,.062,0,.123,0,.185Z"
                            stroke="none"
                        />
                        <path
